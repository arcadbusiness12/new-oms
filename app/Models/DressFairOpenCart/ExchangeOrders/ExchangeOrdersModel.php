 ...
 * @author kamran
 */
class ExchangeOrdersModel extends AbstractDressFairOpenCartModel{
    ...
    public function status(){
        return $this->hasOne('\\App\\Models\\DressFairOpenCart\\Orders\\OrderStatusModel', self::FIELD_ORDER_STATUS_ID, self::FIELD_ORDER_STATUS_ID);
    }
