...
class ProductOptionValueModel extends AbstractDressFairOpenCartModel
{
  ...
  {
    return $this->hasMany(__NAMESPACE__ . "\OptionValueModel", OptionValueModel::FIELD_OPTION_VALUE_ID, self::FIELD_OPTION_VALUE_ID)
