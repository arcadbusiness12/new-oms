...
class DressFairProductsModel extends AbstractDressFairOpenCartModel

{
...

  {
    ...
    return $this->hasOne("App\\Models\\DressFairOpenCart\\Products\\DressFairProductsDescriptionModel", self::FIELD_PRODUCT_ID, self::FIELD_PRODUCT_ID);
...

  {
    ...
    return $this->hasMany(__NAMESPACE__ . "\DressFairProductOptionModel", ProductOptionModel::FIELD_PRODUCT_ID, self::FIELD_PRODUCT_ID)
