 ...
 * @author kamran
 */
class OrdersModel extends AbstractOpenCartModel
{
  ...
  const OPEN_CART_STATUS_PROCESSED = 15;
  ...
  const OPEN_CART_STATUS_COMPLETE = 5;
  ...
  public static function order_status_ids()
  {
    return array(
      OrdersModel::OPEN_CART_STATUS_PENDING,
      OrdersModel::OPEN_CART_STATUS_PROCESSING,
      OrdersModel::OPEN_CART_STATUS_PROCESSED,
      OrdersModel::OPEN_CART_STATUS_COMPLETE,
      OrdersModel::OPEN_CART_STATUS_SHIPPED,
      OrdersModel::OPEN_CART_STATUS_DELIVERED,
      OrdersModel::OPEN_CART_STATUS_RETURNED,
      OrdersModel::OPEN_CART_STATUS_EXCHANGE
    );
  }
