...
<div class="container-fluid relative animatedParent animateOnce my-3">
    <div class="row row-eq-height my-3 mt-3">
        <div class="col-md-12 col-sm-12 col-grid">
         <form method="post" id='ship_orders_to_courier' action="{{ route('exchange.ship') }}">
                ...
                <div class="card no-b mt-3">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-success active btn-sm float-right">Update Status to Shipped</button>
                            </div>
                        </div>
                    </div>
                    <table class="table">
...
function fetchOrderDetails(orderID) {
  ...
  $.ajax({
      ...
      url: APP_URL + '/exchange/get/id/from/airwaybill',
