                        ...
                        <div class="body">
                            ...
                            <table style="width:100%;">
                                ...
                                <tr>
                                  ...
                                  <td align="right" style="width: 30%">
                                      <div class="pull-right"><svg class="barcode" jsbarcode-format="CODE128" jsbarcode-value="{{$order->order_id}}-1"
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="row_{{$order->order_id}}">
                                        <td colspan="1">Total Product(s) = <span class="count">{{ $order->exchangeProducts->count() }}</span></td>
