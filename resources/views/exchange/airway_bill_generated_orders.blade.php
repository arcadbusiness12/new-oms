    ...
    <div class="row row-eq-height my-3 mt-3">
        <div class="col-md-12 col-sm-12 col-grid">
            <div class="card text-black">
              <form method="post" action="{{ URL::to('/exchange/print/awb') }}" target="_blank" id="form_awb_bills">
                @csrf
                    ...
                    <table class="table table-borderd">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="{{URL::to('/orders')}}?order_id={{$order['order_id']}}" target="_blank"> {{$order['order_id']}}-1</a>
                                </td>
                                <td>{{$order['status']}}</td>
