        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="clearfix modal-footer m-t-30">
                    ...
                    <button form-action-data="{{URL::to('exchange/forward/for/shipping')}}" id='confirm_awb_generation' type="button" class="btn btn-success waves-effect">Confirm Generation</button>
