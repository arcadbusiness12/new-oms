<div class="modal fade new_setting_popup" id="new_setting_popup" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      ...
      <div class="modal-content" >
        ...
        <div class="modal-body">
            <div class="sub-setting-loop col-md-12" >
              <form name="setting_form" class="setting_form" class="" action="{{route('employee-performance.photography.saveSettings')}}" method="post">
                          {{ csrf_field() }}
                          ...
                          <div class="row setting-form-row">
                            ...
                            <div class="col-md-4 setting-input">
                              <select class="form-control" name="user" id="user">
                                  ...
                                  <option value="{{$model->user_id}}" >{{$model->firstname}} {{$model->lastname}}</option>
                                  @endforeach
                                </select>
                           ...
                           <div class="row setting-form-row">
                              @foreach($socials as $social)
                                <div class="col-md-2" style="border:1px solid lightgray; padding:9px">                                
                                  <center><label class="social-lable"><input type="checkbox" name="social[]" class="social-check" id="social-check{{$social->id}}" value="{{$social->id}}" > {{$social->name}}</label>
                                  <select class="form-control hidden social_postig_user{{ $social->id }}" name="posting_staff[{{$social->id}}]">
                                    <option value="">Select</option>
                                    @forelse( $posting_staff as $key => $staff )
                                    <option value="{{ $staff->user_id }}">{{ $staff->firstname }}</option>
                                    @empty
                                    @endforelse
                                  </select></center>
                                </div>
                           ...
                           <div class="col-md-12 setting-input">
                            ...
                            {{--  <div class="row " id="">
                                ...
                                <input type="hidden" name="category[]" id="category0">
                                  <select class="form-control selectpicker0" style="display:none;" onchange="cateVlue(0, 2), getSubCategories(this.value, 0)" title="Select Categories" multiple data-actions-box="true" data-live-search="true" placeholder="Select upto 5 tags" id="product_change_status">
                                ...
                                <div class="col-md-2 setting-input ">
                                    ...
                                    <div class="multi-sub0" style="width: 100%;">
                                    <select style="display:none;" onchange="cateSubVlue(0, 2)" class="form-control sub-cete0 selectpickersc0 sub_cate0" id="sub_cate0" title="Sub Categories" multiple data-actions-box="true" data-live-search="true">
                                    
                                    </select>
                                    </div>
                                    
                                <div class="single-sub0">
                                    <select style="" onchange="cateSubVlue(0, 1)" class="form-control ssub-cete0 ssub_cate0" id="ssub_cate0">
...
$('.setting_form').submit(function(event) {
  ...
  $.ajax({
    ...
    // });
    console.log(st);
    $('.new_setting_popup').modal('toggle');
