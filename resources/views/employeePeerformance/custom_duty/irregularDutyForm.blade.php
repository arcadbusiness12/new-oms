                                ...
                                <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <select name="user_group" class="form-control show-tick" onchange="getUsers(this.value)">
                                                ...
                                                <option value="{{$group['id']}}" <?php if($group['id'] == @$user['user_group_id']) {echo 'selected';} ?>>{{$group['name']}}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-sm-3">
                                <label class="form-label">User</label>  
                                    ...
                                    @foreach(@$users as $userr)
                                        <option value="{{$userr['user_id']}}" <?php if($userr['user_id'] == @$user['user_id']) {echo 'selected';} ?>>{{$userr['username']}}</option>
                                        @endforeach
                                    @endif
                                    </select>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <input type="number" name="quantity" value="<?php echo @$duty_details['quantity'] ?>" class="form-control" autocomplete="off" required />
                                    </div>
                                    @if($errors->has('quantity'))
                                        <span class="invalid-response" role="alert">{{$errors->first('quantity')}}</span>
                                        @endif
                                </div>
                            </div>
                            <div class="col-sm-12">
