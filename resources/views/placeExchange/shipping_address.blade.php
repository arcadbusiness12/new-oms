<form name="shipping_address" method="post">
    <div class="row">
        ...
        <div class="col-sm-10 m-b-10">
            <input type="text" name="lastname" class="form-control" value="<?php echo $customer['shipping_lastname']; ?>" placeholder="Last Name" />
        </div> -->
        ...
        <div class="col-sm-10 m-b-10">
            <input type="text" name="city" class="form-control" value="<?php echo $customer['shipping_city']; ?>" placeholder="City" />
        </div> -->
        ...
        <div class="col-sm-12">
            <button type="button" name="back_cutomer_shipping_address" id="back_cutomer_shipping_address" class="btn btn-success pull-left">Back</button>
