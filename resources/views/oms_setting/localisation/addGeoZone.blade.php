            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card no-b">
                        ...
                        <form id="-data-form" action="{{route('save.geo.zones')}}" method="POST">
                            {{ csrf_field() }}
                            <div class="row">
                                <label class="col-2 control-lable text-black"><strong> Geo Zone Name </strong><span class="text-danger"><b>*</b></span></label>
                                <div class="col-10">
                                    <input type="text" name="name" value="" id="geo-form" class="form-control">
                                    @if($errors->has('name'))
                            ...
                            <div class="row pt-4 pb-4">
                                ...
                                <div class="col-10">
                                    <input type="text" name="geo_zone_description" value="" id="form-geo-description" class="form-control">
                                    <span class="invalid-feedback meta-title-error" role="alert">
                                    </span>
                                </div>
                            </div>

                            <h2><strong> Add Countries & Zones </strong></h2>
                                 ...
                                 <table class="table" width="100%" style="border: 1px solid #3f51b5">
                                  ...
                                  <tbody class="table-body-zone">
                                     <tr>
                                         ...
                                         width: 35%;">
                                             <select name="country[]" class="form-control custom-select selecte-country" onchange="getZones(this.value, '0')" id="country-select0">
                                                <option value=""></option>
                                         ...
                                         <td>
                                            <select name="zone[]" class="form-control custom-select select-zone" onchange="getAreas(this.value, '0')" id="zone-select0">
                                               
                                            </select>
                                         </td>
                                         <td class="text-center" style="max-width: 35%;
                                         width: 35%;">
                                            <select name="area[0][]" class="form-control custom-select select-area" id="area-select0" multiple >
