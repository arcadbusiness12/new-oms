                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card no-b">
                        <div class="panel-heading">Add User</div>
                          ...
                          @endif
                          <form action="{{ route('setting.users.edit',$user_info->user_id) }}" method="post" name="form-setting">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="username" value="{{ $user_info->username }}" class="form-control" autocomplete="off" readonly />
                                                @error('username')
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="firstname" value="{{ $user_info->firstname }}" class="form-control" autocomplete="off" />
                                                @error('firstname')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="lastname" class="form-control" value="{{ $user_info->lastname }}" autocomplete="off" />
                                                @error('lastname')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="email" name="email" value="{{ $user_info->email }}"  class="form-control" autocomplete="off" readonly />
                                                @error('email')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-line">
                                                <select name="user_group_id" id="user_group_id" class="form-control show-tick"  >
                                                    ...
                                                    <option value="{{  $userGroup->id }}"  {{ ($user_info->user_group_id == $userGroup->id) ? "selected" : "" }}>{{ $userGroup->name }}</option>
                                                    <?php } ?>
                                                </select>
                                                @error('user_group_id')
                                                    <span class="text-danger">{{ $message }}</span>
