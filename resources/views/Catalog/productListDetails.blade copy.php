                                ...
                                <div class="tab-pane fade  active show text-center p-5" id="w5-images" role="tabpanel" aria-labelledby="w5-images">
                                    ...
                                    <div class="col-4 col-grid border-right border-light" style="border-right: 2px dotted;">
                                        ...
                                        <div class="img-box" id="img-box" style="position: absolute;top:0;left:0">
                                            ...
                                            <input type="button" name="images" id="change_featured_img_btn" class="btn btn-primary change-featured-img-btn" value="Change Image" style="">
                                            <input type="file" name="images" class="featured-img-btn btn btn-primary btn-block" id="upload-file" style="position:absolute;top: 299px;
                                            left: 95px;
                                            z-index: 2;
                                            opacity: 0;" value="Upload" >
                                        </div>
