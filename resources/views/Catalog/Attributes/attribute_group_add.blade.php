                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card no-b">
                        <div class="panel-heading">Add Attribute Groups</div>
                            <form action="{{route('attribute.groups.save')}}" method="post" name="form-setting">
                                {{ csrf_field() }}
                                    <div class="form-group p-4">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="sort_order" value="{{ old('name') }}" class="form-control m-input" placeholder="Enter Sort Order" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-12">
