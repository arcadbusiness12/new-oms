                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card no-b">
                        <div class="panel-heading">
                            Attribute Groups
                            <a href="{{ route('attribute.groups.add') }}" class="btn btn-sm btn-primary float-right">Add</a>
                          </div>
                            ...
                            <table class="table" width="100%" style="border: 1px solid #3f51b5">
                             ...
                             <thead >
                              ...
                              >
                                ...
                                <th scope="col"><center>Sort Order</center></th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $list->sort_order }}</td>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-primary" href="{{ route('attribute.groups.edit',1) }}"><i class="icon-mode_edit"></i></a>
                                        </td>
                                    {{--<td class="text-center">
